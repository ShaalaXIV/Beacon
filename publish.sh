#!/usr/bin/env bash
# Builds the Beacon server for Linux into publish/server-linux-x64/.
#
...
echo
echo "  Building the Beacon server for $RUNTIME"
echo "  ----------------------------------------"
echo
...
dotnet publish src/Beacon.Server \
    -c Release \
    -r "$RUNTIME" \
