...
/// <summary>
/// The Compass palette: dark leather and brass chrome around an aged parchment page.
///
...
public static class Theme
{
    ...
    /// <summary>
    /// Applies the Compass styling to everything drawn until <see cref="Pop"/>.
    ///
    ...
    /// </summary>
    public static Vector4 FlameColour(Compass.Shared.Beacons.BeaconFlame flame)
    {
        if (!flame.IsBurning)
            return Ash;
