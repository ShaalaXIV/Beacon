...
public sealed class SettingsWindow : Window
{
    ...
    public SettingsWindow(
        ...
        : base("Compass settings###CompassSettings")
    {
        this.config = config;
        this.api = api;
        this.atlas = atlas;
    ...
    private void DrawConnection(float scale)
    {
        ...
        Ornament.TextWrapped(Theme.MutedDeep,
            "Compass keeps beacons on a server you or your community runs. Point it at yours.");
    ...
    private void DrawBehaviour()
    {
        ...
        Toggle("Record when I am out at a lit beacon",
            ...
            + "community from an abandoned one. Compass only records this while you are actually\n"
        ...
        Toggle("Use the Compass parchment styling",
            () => config.UseCompassTheme, v => config.UseCompassTheme = v,
    ...
    {
        Ornament.Text(Theme.BrassBright, "What Compass travels with");

        DrawDependency("Lifestream", travel.LifestreamAvailable,
            "Required. Compass uses it for world visits, data centre transfers and aetheryte teleports.");
