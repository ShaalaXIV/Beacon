...
/// <summary>
/// Everything Compass remembers between sessions.
///
...
public sealed class Configuration : IPluginConfiguration
{
    ...
    /// <summary>Base URL of the Compass server, without a trailing slash.</summary>
    ...
    /// <summary>
    /// Let Compass record that you were at a lit beacon, so your card shows when you were last out.
    ///
    ...
    public bool UseCompassTheme { get; set; } = true;
