...
/// </summary>
public sealed class ImageCache(CompassApi api) : IDisposable
{
    ...
    private bool SupportsWebp()
    {
        ...
        try
        {
            ...
            if (!supported)
                Svc.Log.Information("Compass: this machine cannot decode WebP; requesting PNG screenshots instead.");
