...
public sealed class DtrService(Configuration config, AtlasService atlas, TravelService travel) : IDisposable
{
    ...
    public void Tick()
    {
        ...
        entry.Tooltip = new SeString(new TextPayload("Compass - click to open the atlas."));
    }
    ...
    public void Dispose()
    {
        ...
        {
            Svc.Log.Debug(ex, "Compass: could not remove the info bar entry.");
        }
