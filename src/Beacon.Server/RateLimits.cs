...
public static class RateLimits
{
    ...
    public static void AddBeaconRateLimiting(this IServiceCollection services)
    {
    ...
    private static BeaconOptions Options(HttpContext http) =>
        http.RequestServices.GetRequiredService<IOptions<BeaconOptions>>().Value;
