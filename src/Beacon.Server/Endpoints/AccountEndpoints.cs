...
public static class AccountEndpoints
{
    ...
    private static async Task<IResult> GetMeAsync(HttpContext http, BeaconDbContext db, CancellationToken ct)
    {
    ...
    private static async Task<AccountDto> LoadDtoAsync(BeaconDbContext db, AccountEntity account, CancellationToken ct)
    {
