...
public static class ImageEndpoints
{
    public static void MapImageEndpoints(this IEndpointRouteBuilder app)
    {
        ...
        images.MapGet("/{imageId:guid}",
            (Guid imageId, ImageService service, CompassDbContext db, CancellationToken ct, string? format = null) =>
    ...
    private static async Task DiscardAsync(Guid imageId, CompassDbContext db, ImageService images, CancellationToken ct)
    {
        var record = await db.Images.FirstOrDefaultAsync(i => i.Id == imageId, ct);
