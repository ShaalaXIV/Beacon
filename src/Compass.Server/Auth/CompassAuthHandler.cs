...
/// <summary>
/// Authenticates a request from the account secret key in the <c>X-Compass-Key</c> header.
/// </summary>
public sealed class CompassAuthHandler(
...
{
    public const string SchemeName = "CompassKey";

    /// <summary>Claim carrying the account id.</summary>
    public const string AccountIdClaim = "compass:account";

    /// <summary>Claim present when the account is banned from writing.</summary>
    public const string BannedClaim = "compass:banned";
